    ...
    return (
        <div>
            ...
            <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <Card className="bg-sidebar shadow-md">
                    <CardHeader>
                        <h2 className="text-lg font-semibold text-muted-foreground">New Registrations</h2>
                    </CardHeader>
                    <CardContent>
            ...
            <section className="bg-sidebar p-6 rounded-lg shadow-md">
                <h2 className="text-xl font-semibold text-muted-foreground mb-4">Recent Activity</h2>
                <ul className="divide-y divide-gray-200">
                    <li className="py-3">
                        <p className="text-muted-foreground font-medium">User A logged in</p>
                        <p className="text-muted-foreground text-sm">2 hours ago</p>
                    </li>
                    <li className="py-3">
                        <p className="text-muted-foreground font-medium">User B registered</p>
                        <p className="text-muted-foreground text-sm">3 hours ago</p>
                    </li>
                    <li className="py-3">
                        <p className="text-muted-foreground font-medium">Admin approved request</p>
