 ...
 *         id:
 *           type: string
 *           description: The ID of the 'About Us' entry, auto-generated on creation.
 *         title:
 *           type: string
 *           description: Title of the "About Us" entry. This is a unique field.
 *         description:
 *           type: string
 *           description: Detailed description of the "About Us" entry.
 *         files:
 *           type: object
 *           description: JSON object containing files associated with the "About Us" entry.
 ...
 *         images:
 *           type: object
 *           description: JSON object containing images associated with the "About Us" entry.
 *           additionalProperties:
 *             type: object
 *             properties:
 *               imageId:
 ...
 *           type: string
 *           format: date-time
 *           description: Timestamp when the "About Us" entry was created, auto-generated by the system.
 *         updatedAt:
 *           type: string
 *           format: date-time
 *           description: Timestamp of the last update to the "About Us" entry, auto-updated by the system.
 *
 *
 *   errors:
 *     400:
 ...
 *         message:
 *           type: string
 *           example: "Entry with the same title already exists."
 *
 *     415:
 *       type: object
 *       properties:
 ...
 *     description: Create a new About Us entry in the database. This includes validating the request, handling file uploads, and saving the entry with the provided data.
 *
 *     tags:
 *       - About Us
 *
 ...
 *         $link: 'http://localhost:3000/api-doc'
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/errors/415'
