        ...
        <div className='w-full h-full'>
            <div className='w-full h-full max-w-7xl mx-auto grid md:grid-cols-4 gap-4 md:gap-0'>
                ...
                <div className='bg-muted divide-y'>
                    <h1 className="p-2 md:p-4 uppercase whitespace-nowrap text-lg md:text-xl text-primary">More About Us</h1>
                    <Link href={'#'} className='block p-2 md:p-4 hover:underline hover:text-blue-500'>
