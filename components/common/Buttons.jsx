...
export const LitUpBordersButton = (props) => (
  <Button className="p-[3px] relative" title={props.title || "Lit up borders"} {...props}>
...
export const BorderMagicButton = (props) => (
  <Button className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px]" title={props.title || "Border Magic"} {...props}>
