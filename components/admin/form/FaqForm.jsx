        ...
        >
            {({ errors, touched, setFieldValue, resetForm }) => (
                <Form className="space-y-4">
                    <InputWrapper label="Question" error={errors.question} touched={touched.question}>
                        <Field as={Input} name="question" placeholder="Write your question" />
                    </InputWrapper>

                    <InputWrapper label="Answer" error={errors.answer} touched={touched.answer}>
