...
export default function EventForm({ data, isSpacialCategory, category, subCategory }) {
    ...
    const { isLoading: eventSpecialFormLoading, data: eventSpecialForm } = useQuery({
        ...
        >
            {({ errors, touched, values, setFieldValue, resetForm }) => (
                <Form className="space-y-4">
                    ...
                    <div className={`grid ${isSpacialCategory ? 'md:grid-cols-3' : 'md:grid-cols-2'} gap-2`}>

                        <InputWrapper label="Event Date" error={errors.eventDate} touched={touched.eventDate}>
                            <Field as={Input} type="date" name="eventDate" />
                        </InputWrapper>

                        <InputWrapper label="Status" error={errors?.statusId} touched={touched?.statusId}>
                            <ComboboxFormik
                                select="_id"
                                display="status"
                                name="statusId"
                        ...
                        <div hidden={!isSpacialCategory}>
                            <InputWrapper InputWrapper label="Attach a form" error={errors?.specialFormId} touched={touched?.specialFormId}>
                                <ComboboxFormik
                                    select="_id"
                                    display="formTitle"
