        ...
        <div className='relative w-full h-full shadow-lg hover:shadow-2xl transition-all duration-300 ease-in-out rounded-2xl'>
            ...
            <Card className='w-full h-full relative overflow-hidden rounded-xl bg-gradient-to-tr from-card via-secondary/5 to-card/50'>
                ...
                <CardContent className='relative z-20 flex flex-wrap gap-2'>
                    ...
                    <Badge variant='solid' className='text-xs rounded-full shadow-md tracking-widest'>
                        {member?.code}
                    </Badge>
                </CardContent>
                ...
                <CardFooter className='relative z-20'>
                    <div className='text-xs md:text-sm text-muted-foreground'>
                        <p className='font-medium'>Email: <span className='text-primary'>{member?.email}</span></p>
                        <p className='font-medium'>Organization: <span className='text-primary'>{member?.organization}</span></p>
                    </div>
                </CardFooter>
            </Card>
        </div>
