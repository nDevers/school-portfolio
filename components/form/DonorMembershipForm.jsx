    ...
    return (
        <form onSubmit={formik.handleSubmit} className="w-full space-y-10">
            <div className="grid gap-2 md:grid-cols-2 w-full">
                ...
                <InputWrapper label="NID Number" error={formik.errors.nid} touched={formik.touched.nid}>
                    <InputNumber
                ...
                <InputWrapper label="Initial Donation" error={formik.errors.initialDonation} touched={formik.touched.initialDonation}>
                    <Input
