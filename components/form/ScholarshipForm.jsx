...
export default function ScholarshipForm() {
    ...
    const formInfo = {
        ...
        exam: [
            {
                subject: 'Bangla + English + Mathematics + Social + Science + General Knowledge',
                date: '2024-11-13',
                day: 'Friday',
    ...
    const validationSchema = Yup.object().shape({
        ...
        applicantNameEn: Yup.string().required('Applicant name (English) is required'),
    ...
    return (
        <form onSubmit={formik.handleSubmit} className="w-full space-y-10">
            ...
            <div className='flex flex-col items-center justify-center text-base'>
                ...
                <p className='text-lg md:text-xl font-bold'>{formInfo?.eventName}</p>
            ...
            <div className="grid gap-2 md:grid-cols-2 w-full">
                ...
                <InputWrapper label="Father / Mother Phone Number" error={formik.errors.contact} touched={formik.touched.contact}>
                    <Input
                        name="contact"
                        placeholder="Phone"
                ...
                <InputWrapper label="Class Roll No" error={formik.errors.classRollNo} touched={formik.touched.classRollNo}>
                    <Input
                        name="classRollNo"
